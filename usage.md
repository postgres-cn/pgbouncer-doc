...
`auth_mode=any`, then any user is allowed in as a stats\_user.)
...
#### SHOW USERS;
 ...
 pool\_mode
  ~ The user’s override pool\_mode, or NULL if the default will be used
    instead.
...
#### SHOW DATABASES;
 ...
 pool\_mode
  ~ The database’s override pool\_mode, or NULL if the default will be
    used instead.
